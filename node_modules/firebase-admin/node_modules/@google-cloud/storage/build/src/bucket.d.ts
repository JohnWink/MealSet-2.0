...
import { ApiError, BodyResponseCallback, DecorateRequestOptions, DeleteCallback, ExistsCallback, GetConfig, Metadata, ResponseBody, ServiceObject } from 'firebase-admin/node_modules/@google-cloud/storage/build/src/node_modules/@google-cloud/common';
import * as http from 'http';
import { Acl } from 'firebase-admin/node_modules/@google-cloud/storage/build/src/acl';
import { Channel } from 'firebase-admin/node_modules/@google-cloud/storage/build/src/channel';
import { File, FileOptions, CreateResumableUploadOptions, CreateWriteStreamOptions } from 'firebase-admin/node_modules/@google-cloud/storage/build/src/file';
import { Iam } from 'firebase-admin/node_modules/@google-cloud/storage/build/src/iam';
import { Notification } from 'firebase-admin/node_modules/@google-cloud/storage/build/src/notification';
import { Storage, Cors } from 'firebase-admin/node_modules/@google-cloud/storage/build/src/storage';
import { GetSignedUrlResponse, GetSignedUrlCallback, URLSigner, Query } from 'firebase-admin/node_modules/@google-cloud/storage/build/src/signer';
